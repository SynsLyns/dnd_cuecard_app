...
class _RawAutocompleteState<T extends Object> extends State<RawAutocomplete<T>> {
  ...
  FocusNode get _focusNode {
    return widget.focusNode ??
        (_internalFocusNode ??= FocusNode()..addListener(_onChangedField));
  }
  ...
  Future<void> _onChangedField() async {
    ...
    if (!_focusNode.hasFocus) {
      ...
      return;
    } else if (_lastFocusState == true && value.text == _lastFieldText){
      return;
    }
  ...
  void initState() {
    ...
    widget.focusNode?.addListener(_onChangedField);
  }
  ...
  void didUpdateWidget(RawAutocomplete<T> oldWidget) {
    ...
    if (!identical(oldWidget.focusNode, widget.focusNode)) {
      oldWidget.focusNode?.removeListener(_onChangedField);
  ...
  void dispose() {
    ...
    _internalTextEditingController?.dispose();
    widget.focusNode?.removeListener(_onChangedField);
    _internalFocusNode?.dispose();
